...
# 화면 타이틀 설정
pygame.display.set_caption("Moon's Pang!!!")
...
file = resource_path("images/background.png")

# 스테이지 만들기
stage = pygame.image.load(os.path.join(image_path, "stage.png"))
file = resource_path("images/stage.png")
stage_size = stage.get_rect().size
stage_height = stage_size[1] # 스테이지의 높이 위에 캐릭터를 두기 위해 사용
# 캐릭터 만들기
character = pygame.image.load(os.path.join(image_path, "character.png"))
file = resource_path("images/character.png")
...
file = resource_path("images/weapon.png")
...
file = resource_path("images/balloon1.png")
file = resource_path("images/balloon2.png")
